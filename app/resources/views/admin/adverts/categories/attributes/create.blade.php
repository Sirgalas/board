...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Создать атрибут для категории {{$category->name}} </h6>
    </div>
    <div class="card-body">
        {{Form::open(['route'=>['admin.adverts.categories.attributes.store', $category]])}}
            ...
            <div class="form-group">
                ...
                {{Form::text('name', old('name'),['class'=>$errors->has('name')?"form-control is_invalid":"form-control", 'placeholder'=>"Название*", "id"=>"name",'required'=>true])}}
                @if ($errors->has('name'))
            ...
            <div class="form-group">
                ...
                {{Form::text('sort', old('sort'),['class'=>$errors->has('sort')?"form-control is_invalid":"form-control", 'placeholder'=>"Название*", "id"=>"sort",'required'=>true])}}
                @if ($errors->has('sort'))
            ...
            <div class="form-group">
                ...
                {{Form::select('type',$types, old('type'),["id"=>"type","class"=>$errors->has('type')?"form-control is-invalid":"form-control"])}}
                @if ($errors->has('type'))
            ...
            <div class="form-group">
                ...
                {{Form::textarea('variants', old('variants'),['class'=>$errors->has('sort')?"form-control is_invalid":"form-control",  "id"=>"variants"])}}
