...
@section('content')
    {{Form::open(['route'=>(['admin.pages.store']),'method'=>'POST'])}}
        ...
        <div class="form-group">
            ...
            {{Form::textarea('description',old('description') ,['class'=>$errors->has('description') ?"form-control summernote is-invalid":"form-control summernote",'required'=>true,'rows'=>10])}}
