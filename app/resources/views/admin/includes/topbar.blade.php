    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - Messages -->
                <span class="badge badge-danger badge-counter">{{count($menuTicket)}}</span>
            </a>
            <!-- Dropdown - Messages -->
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                ...
                @foreach($menuTicket as $ticket)
                <a class="dropdown-item d-flex align-items-center" href="{{route('admin.tickets.show', $ticket)}}">
                    ...
                    <div class="font-weight-bold">
                        ...
                        <div class="small text-gray-500">{{$ticket->user->name}} · {{$ticket->created_at}}</div>
                    </div>
                </a>
                @endforeach
